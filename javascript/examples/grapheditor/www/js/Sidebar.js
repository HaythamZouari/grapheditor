...
Sidebar.prototype.addConnectionPalette = function(expand)
{
	...
	var fns = [
		...
		30, 60, '', 'bouton', null, null, this.getTagsForStencil(gnmess, 'bouton', dtmess).join(' ')),
		this.createVertexTemplateEntry(mess + 'lampe;', 
		30, 60, '', 'lampe', null, null, this.getTagsForStencil(gnmess, 'lampe', dtmess).join(' ')),
		this.createVertexTemplateEntry(mess + 'lampe1;', 
		30, 60, '', 'lampe1', null, null, this.getTagsForStencil(gnmess, 'lampe1', dtmess).join(' ')),
	...
	this.createVertexTemplateEntry(mess + 'layterminal-2p;',
			30, 60, '', 'layterminal-2p', null, null, this.getTagsForStencil(gnmess, 'layterminal-2p', dtmess).join(' ')),
	this.createVertexTemplateEntry(mess + 'layterminal-3pg;',
			30, 60, '', 'layterminal-3pg', null, null, this.getTagsForStencil(gnmess, 'layterminal-3pg', dtmess).join(' ')),
	this.createVertexTemplateEntry(mess + 'layterminal-4p;',
			30, 60, '', 'layterminal-4p', null, null, this.getTagsForStencil(gnmess, 'layterminal-4p', dtmess).join(' ')),
	this.createVertexTemplateEntry(mess + 'layterminal-6p;',
			30, 60, '', 'layterminal-6p', null, null, this.getTagsForStencil(gnmess, 'layterminal-6p', dtmess).join(' ')),
	this.createVertexTemplateEntry(mess + 'layterminal-8p;',
			30, 60, '', 'layterminal-8p', null, null, this.getTagsForStencil(gnmess, 'layterminal-8p', dtmess).join(' ')),
	this.createVertexTemplateEntry(mess + 'layterminal-9p;',
			30, 60, '', 'layterminal-9p', null, null, this.getTagsForStencil(gnmess, 'layterminal-9p', dtmess).join(' ')),
	this.createVertexTemplateEntry(mess + 'layterminal-g8p;',
			30, 60, '', 'layterminal-g8p', null, null, this.getTagsForStencil(gnmess, 'layterminal-g8p', dtmess).join(' ')),
